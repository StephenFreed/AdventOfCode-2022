...
int main() {
    ...
    if (input_file.is_open()) {
        ...
        while (std::getline(input_file, current_line)) {
            ...
            if (left_assignment_2 >= left_assignment_1 && right_assignment_1 >= left_assignment_2) {
                fully_contain_total++;
            }
            else if (right_assignment_2 <= right_assignment_1 && right_assignment_2 >= left_assignment_1) {
                fully_contain_total++;
            }
            else if (right_assignment_1 <= right_assignment_2 && right_assignment_1 >= left_assignment_2) {
                fully_contain_total++;
            }
            else if (left_assignment_1 <= right_assignment_2 && left_assignment_1 >= left_assignment_2) {
                fully_contain_total++;
            }
    ...
    std::cout << "Overlapping Total: " << fully_contain_total << std::endl;
}
